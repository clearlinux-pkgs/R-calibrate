...
Version  : 1.7.6
Release  : 21
URL      : https://cran.r-project.org/src/contrib/calibrate_1.7.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/calibrate_1.7.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592412858
